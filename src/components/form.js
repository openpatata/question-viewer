    ...
    <div className="question-form">
      <div className="question-form__search-array">
        ...
        <div className="question-form__status-toggles">
          ...
          <label htmlFor="__answered"
                 title="Eμφάνιση απαντημένων ερωτήσεων"></label>
          <input id="__unanswered"
          ...
          <label htmlFor="__unanswered"
                 title="Eμφάνιση αναπάντητων ερωτήσεων"></label>
        </div>
      </div>
    </div>
  )
